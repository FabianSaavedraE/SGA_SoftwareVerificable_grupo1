...
def test_compute_type_average_with_percentages():
    ...
    evaluations = [
        MockEvaluation(
            ponderation=50, student_evaluations=[MockStudentEvaluation(1, 5.0)]
        ),
        MockEvaluation(
            ponderation=50, student_evaluations=[MockStudentEvaluation(1, 7.0)]
        ),
    ]
...
def test_compute_student_final_grade_with_percentages():
    ...
    evaluation_type_1 = MockEvaluationType(
        ...
        evaluations=[
            MockEvaluation(
                ponderation=100,
                student_evaluations=[MockStudentEvaluation(1, 6.0)],
            )
        ],
    )
    ...
    evaluation_type_2 = MockEvaluationType(
        ...
        evaluations=[
            MockEvaluation(
                ponderation=100,
                student_evaluations=[MockStudentEvaluation(1, 4.0)],
            )
        ],
    )
...
def test_compute_student_final_grade_without_percentages():
    ...
    evaluation_type_1 = MockEvaluationType(
        ...
        evaluations=[
            MockEvaluation(
                ponderation=1,
                student_evaluations=[MockStudentEvaluation(1, 5.0)],
            )
        ],
    )
    ...
    evaluation_type_2 = MockEvaluationType(
        ...
        evaluations=[
            MockEvaluation(
                ponderation=1,
                student_evaluations=[MockStudentEvaluation(1, 3.0)],
            )
        ],
    )
