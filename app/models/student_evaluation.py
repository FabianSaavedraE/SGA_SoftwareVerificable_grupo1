...
class StudentEvaluations(db.Model):
    ...
    student = db.relationship('Student', back_populates='student_evaluations', passive_deletes=True)
    evaluation = db.relationship('Evaluation', back_populates='student_evaluations', passive_deletes=True)
